...
class GoogleMapickup extends StatefulWidget {
  const GoogleMapickup({super.key});

  @override
  State<GoogleMapickup> createState() => _GoogleMapickupState();
}

class _GoogleMapickupState extends State<GoogleMapickup> {
